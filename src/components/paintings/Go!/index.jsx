...
export default function Go(props) {
  const { nodes, materials } = useGLTF("src/assets/blender-objects/paintings/go!-exp.gltf");
  ...
  <Canvas style={{height: '80vh', width:'60vh'}} className="artwork-container">
    ...
    <OrbitControls enableZoom={false} object={Go}/>
    </Suspense>
  </Canvas>
  );
}

useGLTF.preload("src/assets/blender-objects/paintings/go!-exp.gltf");