...
export default function Essay(props) {
  const { nodes, materials } = useGLTF("src/assets/blender-objects/paintings/essay-exp.gltf");
  ...
  <Canvas style={{height: '80vh', width:'60vh'}} className="artwork-container">
    ...
    <OrbitControls enableZoom={false} object={Essay}/>
    </Suspense>
  </Canvas>
  );
}

useGLTF.preload("src/assets/blender-objects/paintings/essay-exp.gltf");