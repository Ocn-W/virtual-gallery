...
export default function EndGame(props) {
  const { nodes, materials } = useGLTF("src/assets/blender-objects/paintings/endgame-exp.gltf");
  ...
  <Canvas style={{height: '80vh', width:'60vh'}} className="artwork-container">
    ...
    <OrbitControls enableZoom={false} object={EndGame}/>
    </Suspense>
  </Canvas>
  );
}

useGLTF.preload("src/assets/blender-objects/paintings/endgame-exp.gltf");